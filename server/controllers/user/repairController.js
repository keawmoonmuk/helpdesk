...
exports.getRepairs = async (req, res) => {
  try {
    ...
    //console.log("repairRequests:", repairRequests);
    res.json({
...
exports.addRepair = async (req, res) => {
  try {
    ...
    const createdBy = req.user ? req.user.userId : null; // ดึง user_id จาก token
    // const createdBy = 1; // ใช้ค่า 1 แทน user_id สำหรับการทดสอบ
...
exports.editRepair = async (req, res) => {
  try {
    ...
    const updatedBy = req.user ? req.user.userId : null; // ดึง user_id จาก token
    ...
    console.log("assetSerial:", assetSerial);
    console.log("assetLocation:", assetLocation);
    console.log("detailRepair:", detailRepair);
...
exports.deleteRepair = async (req, res) => {
  try {
    ...
    if (
      ...
      repair.createdBy !== req.user.userId // ผู้ใช้ทั่วไปลบได้เฉพาะรายการของตัวเอง
    ) {
